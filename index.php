...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Header end  -->
                <div class="row justify-content-center align-items-stretch mt-20 g-4">
								<div class="col-md-3 col-6"><button type="button" class="btn" data-toggle="modal" data-target="#exampleModalCenter">
						<div class="card pc-cd h-100 view-products" data-id="7">
							<div class="img">
								<img src="https://www.rentalhomeservice.in/myadmin/uploads/property/20240729_125429.png" alt="" style="aspect-ratio:4/3 ; object-fit:cover">
							</div>
							<div class="title1 p-2">
								<p class="m-0 text-center text-capitalize">
									<b>Agricultural property for sale </b>
								</p>
							</div>
						</div></button>
					</div>
                    <div class="col-md-3 col-6"><button type="button" class="btn" data-toggle="modal" data-target="#exampleModalCenter1">
						<div class="card pc-cd h-100 view-products" data-id="6">
							<div class="img">
								<img src="https://www.rentalhomeservice.in/myadmin/uploads/property/20240725_220928.png" alt="" style="aspect-ratio:4/3 ; object-fit:cover">
							</div>
							<div class="title1 p-2">
								<p class="m-0 text-center text-capitalize">
									<b>Commercial sale </b>
                    ...
                    <div class="col-md-3 col-6"><button type="button" class="btn" data-toggle="modal" data-target="#exampleModalCenter2">
						<div class="card pc-cd h-100 view-products" data-id="3">
							<div class="img">
								<img src="https://www.rentalhomeservice.in/myadmin/uploads/property/20240725_2159391.png" alt="" style="aspect-ratio:4/3 ; object-fit:cover">
							</div>
							<div class="title1 p-2">
								<p class="m-0 text-center text-capitalize">
									<b>Residential sale </b>
								</p>
							</div>
						</div></button>
					</div>
                    <div class="col-md-3 col-6"><button type="button" class="btn" data-toggle="modal" data-target="#exampleModalCenter3">
						<div class="card pc-cd h-100 view-products" data-id="2">
							<div class="img">
								<img src="https://www.rentalhomeservice.in/myadmin/uploads/property/WhatsApp_Image_2024-07-23_at_5_56_51_PM_(1).jpeg" alt="" style="aspect-ratio:4/3 ; object-fit:cover">
							</div>
							<div class="title1 p-2">
								<p class="m-0 text-center text-capitalize">
									<b>commercial rental </b>
								</p>
							</div>
						</div></button>
					</div>
                    <div class="col-md-3 col-6"><button type="button" class="btn" data-toggle="modal" data-target="#exampleModalCenter4">
						<div class="card pc-cd h-100 view-products" data-id="5">
							<div class="img">
								<img src="https://www.rentalhomeservice.in/myadmin/uploads/property/20240725_222525.png" alt="" style="aspect-ratio:4/3 ; object-fit:cover">
							</div>
							<div class="title1 p-2">
								<p class="m-0 text-center text-capitalize">
									<b>Rental For Bachlors </b>
								</p>
							</div>
						</div></button>
					</div>
                                ...
                                <div class="modal-content bg-success">
                                    <div class="modal-header">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="card pc-cdtum view-products gap-3" data-id="7">
							                    <div class="img">
								                    <img src="https://www.shutterstock.com/shutterstock/photos/2280215221/display_1500/stock-photo-vacant-land-management-land-reclamation-for-land-plot-for-building-house-aerial-view-land-pins-2280215221.jpg" alt="" style="aspect-ratio:4/3 ; object-fit:cover">
							                    </div>
							                        <div class="title1 p-2">
								                        <p class="m-0 text-center text-capitalize">
									                        <b>Aadiwashi land for sale </b>
								                        </p>
							                        </div>
						                        </div>
                                                    <div class="card pc-cdtum view-products" data-id="7">
							                            <div class="img">
								                            <img src="https://www.shutterstock.com/shutterstock/photos/2119284422/display_1500/stock-photo-land-plot-in-aerial-view-top-view-land-green-field-agriculture-plant-with-pins-pin-location-icon-2119284422.jpg" alt="" style="aspect-ratio:4/3 ; object-fit:cover">
							                            </div>
							                                <div class="title1 p-2">
								                                <p class="m-0 text-center text-capitalize">
									                                <b>Agricultural land for sale </b>
								                                </p>
							                                </div>
						                                </div>
                                                    </div>
                            ...
                            <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
                                <div class="modal-content bg-success">
                                    <div class="modal-header">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="col-3 pc-cdtum view-products" data-id="7">
							                    <div class="img">
								                    <img src="https://www.shutterstock.com/shutterstock/photos/2280215221/display_1500/stock-photo-vacant-land-management-land-reclamation-for-land-plot-for-building-house-aerial-view-land-pins-2280215221.jpg" alt="" style="aspect-ratio:4/3 ; object-fit:cover">
							                    </div>
							                        <div class="title1 p-2">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="col-3 pc-cdtum view-products" data-id="7">
							                    <div class="img">
                                                    ...
                                                    <div class="col-3 pc-cdtum view-products w-60" data-id="7">
							                                <div class="img">
								                                <img src="https://www.shutterstock.com/shutterstock/photos/2280215221/display_1500/stock-photo-vacant-land-management-land-reclamation-for-land-plot-for-building-house-aerial-view-land-pins-2280215221.jpg" alt="" style="aspect-ratio:4/3 ; object-fit:cover">
							                                </div>
							                                    <div class="title1 p-2">
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative m-t-15" style="background-image: url('images/banner/rshmpg.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Our premium service offers comprehensive solutions tailored to your needs, ensuring efficiency, reliability, and exceptional customer satisfaction every time.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Our rental service provides affordable, high-quality equipment with flexible terms, ensuring convenience and satisfaction for all your needs.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Beautiful 3-bedroom home nestled in a tranquil rural area, featuring ample land, scenic views, and ideal for nature lovers seeking peace.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Secure your future with our legally vetted investment properties, offering lucrative returns and peace of mind in prime locations.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Expert guidance, prime properties, trusted service, exceptional deals, client satisfaction.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Unmatched expertise, personalized service, quality homes, seamless transactions, satisfied clients.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Skilled agents, local knowledge, expert advice, reliable service, client-focused.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Share insights, opinions, and experiences on property listings, market trends, and strategies for successful acquisition.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Examine property documents, legal papers, and inspection reports to verify authenticity and compliance.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Finalize the purchase through negotiation, agreement, and transaction completion after thorough evaluation and planning.</p>
                        </div>
                    </div>
                </div>
            </div>
